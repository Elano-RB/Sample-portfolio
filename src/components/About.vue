<template>
	...
	<div class="row justify-content-center align-items center py-4 py-lg-5" id="landing">
		...
		<div class="col-md-7 col-lg-5 text-white py-md-5 py-lg-5">
			...
			<p class="text-justify landing-text">Charles Babbage KH FRS (/ˈbæbɪdʒ/; 26 December 1791 – 18 October 1871) was an English polymath. A mathematician, philosopher, inventor and mechanical engineer, Babbage originated the concept of a digital programmable computer.
